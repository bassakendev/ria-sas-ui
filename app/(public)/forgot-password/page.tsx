                    ...
                    <div className="relative z-10 max-w-md">
                        ...
                        <div className="mt-12 p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
                            <div className="flex items-center justify-center">
                                <Mail className="h-24 w-24 text-white/40" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-full max-w-md">
                        ...
                        {success ? (
                            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-green-700 dark:text-green-400">
                                            Si un compte existe avec l&apos;adresse <strong>{email}</strong>, vous recevrez un email avec un lien pour réinitialiser votre mot de passe dans quelques instants.
                                        </p>
                                ...
                                <Link
                                    href="/login"
                                    className="mt-6 w-full inline-flex justify-center items-center px-4 py-2 border border-green-600 dark:border-green-500 text-green-700 dark:text-green-400 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors"
                                >
                                    Retour à la connexion
                                </Link>
                            </div>
